...
public class DoctorProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel10.add(emailBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 150, 50));
        ...
        jPanel10.add(nameBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 150, 50));
        ...
        jPanel10.add(usnBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, 150, 50));
        ...
        jPanel10.add(pswdBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 150, 50));
        ...
        nameText.setFont(new java.awt.Font("Garamond", 0, 18)); // NOI18N
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(nricText, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void saveButton1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButton1MouseReleased
        ...
        switch(result){
            case 0:
                ...
                return;
            case 1:
                nameError1.setText("Name cannot start with whitespace");
                return;
            case 2:
    ...
    private void saveButton2MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButton2MouseReleased
        ...
        switch (result) {
            ...
            case 1:
                ...
                return;
            case 2:
                usernameError1.setText("Username cannot start with whitespace");
                return;
            case 3:
    ...
    private void saveButton3MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButton3MouseReleased
        ...
        switch (confirmation){
            case 0:
                ...
                return;
            case 1:
                confirmPswdError1.setText("Confirm password cannot start with whitespace");
                return;
            case 2:
    ...
    private void saveButton4MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButton4MouseReleased
        ...
        switch (result) {
            ...
            case 1:
                ...
                return;
            case 2:
                emailError1.setText("Email cannot contain whitespace");
                return;
            case 3:
